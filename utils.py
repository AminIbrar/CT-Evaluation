...
# Check authentication for module pages
# Check authentication for module pages
def check_authentication():
    ...
    # Prevent admins from accessing reader modules
    if st.session_state.get('is_admin', False):
        st.error("⛔ Admin users cannot access reader modules.")
...
def setup_page_layout(title, description, csv_path="", result_column=""):
    ...
    # Initialize module session state
    init_module_session_state()
